<template>
    <div @click="$emit('transmitTaskToParent', task)" class="w-full p-4 border-b-2 border-gray-200 cursor-pointer hover:bg-blue-100 rounded-lg">
        ...
        <div class="ps-9 flex font-semibold">
            ...
            <div class="border-[1px] border-gray-500 mx-2"></div>
